        ...
        <div class="row">
            <div class="col-xs-6 col-md-12 col-lg-12">
                <div class="panel panel-primary">
                    ...
                    <form action="Admin/Product/postEditProduct/{{$product->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row" style="margin-bottom:40px">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  type="text" name="code" class="form-control" value="{{$product->name}}">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <img id="avatar" class="thumbnail" width="100%" height="350px" src="source/backend/img/{{$product->img}}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="Admin/Product/listProduct" class="btn btn-danger" type="reset">Huỷ bỏ</a>
                                </div>
                            </div>
