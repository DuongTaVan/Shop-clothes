...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-xs-6 col-md-12 col-lg-12">
                <form action="Admin/Product/postProduct" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row" style="margin-bottom:40px">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <img id="avatar" class="thumbnail" width="100%" height="350px" src="source/backend/img/import-img.png">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
