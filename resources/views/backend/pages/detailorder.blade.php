						...
						<div class="bootstrap-table">
							<div class="table-responsive">
								...
								<table class="table table-bordered" style="margin-top:20px;">
									...
									<tbody>
										@foreach($prd_order as $prd)
										<tr>
											<td>{{$prd->id}}</td>
											<td>
												<div class="row">
													<div class="col-md-4">
														<img width="100px" src="source/backend/img/{{$prd->img}}" class="thumbnail">
													</div>
													<div class="col-md-8">
														<p><b>Mã sản phẩm</b>: {{$prd->code}}</p>
														<p><b>Tên Sản phẩm</b>: {{$prd->name}}</p>
														
													</div>
												</div>
											</td>
											
											<td>{{number_format($prd->price)}} VNĐ</td>
								...
								<div class="alert alert-primary" role="alert" align='right'>
									<a name="" id="" class="btn btn-success" href="Admin/Order/processed/{{$order->id}}" role="button">Đã xử lý</a>
								</div>
							</div>
						</div>
